...
const Quickview: FC<QuickviewProps> = ({}) => {
    ...
    <div className='hidden sm:flex flex-col justify-evenly items-center w-[55%] h-3/4 sm:mt-28 xl:mt-28 2xl:mt-36 sm:ml-10 xl:ml-10 2xl:ml-40 pr-8 flex-wrap'>
        <div className='hidden sm:flex flex-row justify-center w-96'>
            <motion.div 
        ...
        {showProjects &&
        <div className='hidden sm:flex flex-row justify-evenly items-center h-3/4 flex-wrap overflow-y-auto overflow-x-hidden'>
        ...
        {!showProjects &&
        <div className='hidden sm:flex flex-row h-3/4 w-[75%] justify-between pt-2 flex-wrap overflow-y-auto overflow-x-hidden'>
